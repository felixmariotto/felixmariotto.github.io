...
function CurveEditor() {
	...
	var cornerMaterial = new THREE.MeshPhongMaterial({color:0xff00ff});
	var twistMaterial = new THREE.MeshPhongMaterial({color:0xffff00});
	var selectMaterial = new THREE.MeshPhongMaterial({color:0xffffff});
	...
	function drawLineHelper() {
		...
		for (let i=0 ; i<curves.length ; i++) {
			curves[i].tube.geometry = new THREE.TubeBufferGeometry(
	...
	// sub-arrays like this : ["corner", new THREE.Vector(0, 1, 0)].
